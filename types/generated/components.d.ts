...
export interface BlocksContentList extends Struct.ComponentSchema {
  ...
  attributes: {
    comp: Schema.Attribute.Enumeration<
      ['BlogCard', 'EventCard', 'DeliveryCard']
    > &
      Schema.Attribute.DefaultTo<'BlogCard'>;
...
export interface ElementsLink extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    inNewTab: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
