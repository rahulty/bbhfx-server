...
export interface ApiClaimedDeliveryClaimedDelivery
  extends Struct.CollectionTypeSchema {
  collectionName: 'claimed_deliveries';
  info: {
    description: '';
    displayName: 'Claimed Delivery';
    pluralName: 'claimed-deliveries';
    singularName: 'claimed-delivery';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['rider', 'buddy', 'backup']> &
      Schema.Attribute.DefaultTo<'rider'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDeliveryDelivery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    claimed_deliveries: Schema.Attribute.Relation<
      'oneToMany',
      'api::claimed-delivery.claimed-delivery'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    endPickupDateTime: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reqRiders: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<1>;
    size: Schema.Attribute.String;
    startPickupDateTime: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    toAddress: Schema.Attribute.String;
    toCenter: Schema.Attribute.Enumeration<
      [
        'Halifax Community Fridge',
        'Darthmouth Community Fridge',
        'Veith House',
        'Others',
      ]
    >;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.info-block', 'blocks.hero-section', 'blocks.content-list']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::claimed-delivery.claimed-delivery': ApiClaimedDeliveryClaimedDelivery;
